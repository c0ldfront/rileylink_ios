...
class MainViewController: RileyLinkSettingsViewController {
    ...
    override func viewDidLoad() {
        ...
        imageView.tintColor = VisualDesign.rileyLinkTint(compatibleWith: tableView.traitCollection)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .pump:
            if let pumpManager = deviceDataManager.pumpManager {
                ...
                case .addPod:
                    cell = tableView.dequeueReusableCell(withIdentifier: TextButtonTableViewCell.className, for: indexPath)
                    cell.textLabel?.text = NSLocalizedString("Setup Omnipod", comment: "Title text for button to pair a new pod")
                }
            }
        }
        return cell
        ...
        case .pump:
            if let pumpManager = deviceDataManager.pumpManager {
                ...
                if let rileyLinkManagerViewController = setupViewController as? RileyLinkManagerSetupViewController {
                    rileyLinkManagerViewController.rileyLinkDeviceManager = deviceDataManager.rileyLinkDeviceManager
                }
